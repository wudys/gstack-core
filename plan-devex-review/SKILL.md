...
- **Early-stage founder building MVP** -- 30-minute integration tolerance, won't read docs, copies from README
...
An early-stage founder expects `tool.do(thing)`. A platform engineer expects
...
style? An early-stage founder needs copy-paste examples front and center. A platform engineer
